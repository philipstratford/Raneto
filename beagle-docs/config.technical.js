...
var config = {
  ...
  content_dir : path.join(__dirname, 'technical-docs'),
  ...
  image_url: '/technical/_technical_images', //I'm not making any use of this for Beagle documentation, paths to images don't use this variable (though it does work)
